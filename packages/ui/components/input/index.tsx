...
const inputFieldStyle = tva({
  base: 'flex-1 text-foreground text-sm md:text-sm font-body py-1 h-full placeholder:text-muted-foreground  web:outline-none ios:leading-[0px] web:cursor-text web:data-[disabled=true]:cursor-not-allowed',
});

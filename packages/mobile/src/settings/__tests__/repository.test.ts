      ...
      runAsync: jest.fn(async (sql: string, params: unknown[]) => {
        if (sql.includes("UPDATE app_settings")) {
          ...
          this.row = {
            ...
            show_auxiliary_field_marks: params[13],
            show_performer_labels: params[14],
            show_performer_names: params[15],
            show_prop_labels: params[16],
            show_prop_names: params[17],
            show_transition_markers: params[18],
            show_all_transition_sets: params[19],
            previous_transition_set_count: params[20],
            next_transition_set_count: params[21],
            distance_green_threshold_steps: params[22],
            distance_yellow_threshold_steps: params[23],
            motion_interpolation_enabled: params[24],
            mock_live_position_enabled: params[25],

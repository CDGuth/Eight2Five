      ...
      runAsync: jest.fn(async (sql: string, params: unknown[]) => {
        if (sql.includes("UPDATE app_settings")) {
          this.row = {
            ...
            mock_live_position_enabled: params[23],
            mock_live_position_x_steps: params[24],
            mock_live_position_y_steps: params[25],
            comfortable_anchor_range_meters: params[26],
          };
        } else {
          this.row = {
            ...
            active_drill_id: params[28],
            selected_drill_page_id: params[29],
          };
        }

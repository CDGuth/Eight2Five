  ...
  return (
    <ManagerScreen>
      ...
      <SectionCard title="Actions">
        <VStack space="sm">
          <ManagerButton
            ...
            variant="outline"
            onPress={() =>
              router.push(`/devices/${device.id}/diagnostics` as never)
            }
          />
          <ManagerButton
            label="Disconnect"
      ...
      <SectionCard
        ...
        description={
          available
            ? "Makes UWB passive, verifies it, then restores and verifies the PANS default PAN ID 0 used for unassigned devices."
